        ...
        <div className="card card-pad" style={{ gridColumn: '1 / -1' }}>
          ...
          {profile.commissionTier === 'TIER_1' && (
            <div style={{ background: 'var(--brand-tint)', borderRadius: 'var(--r)', padding: 14, fontSize: 13 }}>
              <strong>Tier 1</strong> — {rates.TIER_1.platformPercent}% commission, no promotions. Upgrade to <strong>Tier 2</strong> ({rates.TIER_2.platformPercent}%) to unlock promotional cards.
            </div>
          )}
          {profile.commissionTier === 'TIER_2' && (
            <div style={{ background: '#E8F8F1', borderRadius: 'var(--r)', padding: 14, fontSize: 13 }}>
              <strong>Tier 2</strong> — {rates.TIER_2.platformPercent}% commission, promotions unlocked ✓
            </div>
          )}
        </div>
      </div>
