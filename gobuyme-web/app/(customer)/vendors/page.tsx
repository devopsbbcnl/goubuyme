              ...
              <Link key={v.id} href={`/vendor/${v.id}`} className="vendor-card">
                ...
                <div className="card-body">
                  ...
                  <div className="vendor-meta">
                    <span className="rating"><svg width="12" height="12" viewBox="0 0 24 24" fill="#FF521B" style={{ display: 'inline', verticalAlign: 'middle', marginRight: 3 }}><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>{v.rating != null ? v.rating.toFixed(1) : '0.0'}</span>
                    <span>{v.city}</span>
