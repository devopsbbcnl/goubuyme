...
// Interactive landing-page content (hero carousel, categories, promos, vendor
// grid). Rendered by the server component at app/page.tsx, which owns the
// page metadata, JSON-LD and server-rendered SEO sections.
