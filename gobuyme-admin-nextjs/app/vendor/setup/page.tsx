      ...
      <PageShell T={T}>
        <div style={{ textAlign: 'center', maxWidth: 440 }}>
          ...
          <div style={{ background: '#fff', border: `1px solid ${T.border}`, borderRadius: 4, padding: 16, fontSize: 13, color: '#444' }}>
            In the meantime, visit our <a href="https://gobuyme.shop/how-to" style={{ color: '#FF521B', fontWeight: 600, textDecoration: 'none' }}>How To</a> pages and learn how to manage your store on the go.
          </div>
        </div>
      </PageShell>
    );
