...
function TrackingMap({
	...
	if (Constants.appOwnership === 'expo') {
		return (
			<MapFallback
				title="Live map requires a development build"
				subtitle="Tracking details continue below."
			/>
		);
	}
	...
	try {
		...
		return (
			<MapFallback
				...
				subtitle="Use a development build to enable live map tracking."
			/>
		);
	}
}
